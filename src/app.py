...
def signup_for_activity(activity_name: str, email: str):
    ...
    return {"message": f"Signed up {email} for {activity_name}", "activity": activity_name, "participants": activity["participants"]}
...
def unregister_participant(activity_name: str, email: str):
    ...
    return {"message": f"{email} removido de {activity_name}", "participants": activity["participants"]}
"""
